        ...
        <div className="row gx-5">
          <div className="col-lg-4 mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                ...
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">Blog post title</h5></a>
          ...
          <div className="col-lg-4 mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                ...
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">Another blog post title</h5></a>
          ...
          <div className="col-lg-4 mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                <div className="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">The last blog post title is a little bit longer than the others</h5></a>
